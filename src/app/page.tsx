      ...
      <section className="px-5">
        <div className="flex gap-2 flex-col-reverse md:flex-row">
          ...
          <div className="hero-img gap-2 rounded-3xl overflow-hidden relative">
            ...
            <div className="absolute bottom-0 inset-x-0 flex justify-end mb-4 gap-x-4">
              <div className="flex border-2 p-1 border-white rounded-full items-center hover:cursor-pointer transition-all duration-500 hover:bg-white">
                <span className="text-black z-10 text-md font-rubik">
                  learn more
                </span>
                <FaCircleArrowDown className="text-black ml-2" />
              </div>
              <div className="flex border-2 p-1 border-white rounded-full items-center">
                <span className="text-black z-10 font-normal text-md font-rubik">
                  contact us
                </span>
                <MdOutlineMail className="text-black ml-2" />
              </div>
            </div>
          </div>
        </div>
